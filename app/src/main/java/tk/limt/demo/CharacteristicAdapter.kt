...
class CharacteristicAdapter(
...
) : Adapter<ItemCharacteristicBinding, BluetoothGattCharacteristic>(items) {
    ...
    init {
        clickListener = object : OnItemClickListener<
            ...
            override fun onItemClick(
                view: View,
                holder: Holder<ItemCharacteristicBinding>,
    ...
    override fun onBindViewHolder(holder: Holder<ItemCharacteristicBinding>, position: Int) {
